...
@Composable
fun KycPanScreen(navController: NavController) {
    ...
    Column(
        ...
        Box(
            ...
            Button(
                onClick = { navController.navigate(Screen.KycPayment.route) },
                enabled = isValid,
                modifier = Modifier
                    .fillMaxWidth()
                    .height(56.dp),
        ...
        Box(
            ...
            if (image != null) {
                ...
                Column(
                    ...
                    Text(
                        text = if (title.contains("Front")) "Tap to upload front side"
                        else "Tap to upload back side",
                        fontWeight = FontWeight.SemiBold,
                        fontSize = 13.sp,
                        color = PrimaryOrange
                    )
